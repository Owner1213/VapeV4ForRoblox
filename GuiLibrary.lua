if shared.VapeExecuted then
	...
	local function vapeGithubRequest(scripturl)
		if not isfile("vape/"..scripturl) then
			local suc, res = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/Owner1213/VapeV4ForRoblox/"..readfile("vape/commithash.txt").."/"..scripturl, true) end)
			assert(suc, res)
	...
	hoverbox.Font = shared.deffont or Enum.Font.Arial
	...
	GuiLibrary["CreateMainWindow"] = function()
		...
		settingstext.Font = shared.deffont or Enum.Font.Arial
		...
		windowapi["CreateCustomToggle"] = function(argstable)
			...
			buttontext.Font = shared.deffont or Enum.Font.Arial
		...
		windowapi["CreateDivider2"] = function(text)
			...
			if text then
				...
				windowapi3["CreateSlider"] = function(argstable)
					...
					text1.Font = shared.deffont or Enum.Font.Arial
					...
					text2.Font = shared.deffont or Enum.Font.Arial
					...
					text3.Visible = false
					text3.Font = shared.deffont or Enum.Font.Arial
	...
	GuiLibrary["CreateCustomWindow"] = function(argstablemain)
		...
		windowtext.Font = shared.deffont or Enum.Font.Arial
		...
		windowapi["CreateDropdown"] = function(argstable)
			...
			drop1.Font = shared.deffont or Enum.Font.Arial
	...
	GuiLibrary["CreateWindow"] = function(argstablemain2)
		...
		--	children2.LayoutOrder = amount
			...
			bindtext.Parent = bindbkg
			bindtext.Font = shared.deffont or Enum.Font.Arial
			bindtext.Size = UDim2.new(1, 0, 1, 0)
			...
			bindtext3.Font = shared.deffont or Enum.Font.Arial
			bindtext3.TextXAlignment = Enum.TextXAlignment.Left
			...
			buttonapi["CreateDropdown"] = function(argstable)
				...
				dropGuiLibrary["UpdateList"] = function(val)
					...
					for numbe, listobj in pairs(val) do
						...
						drop2.BackgroundColor3 = Color3.fromRGB(26, 25, 26)
						drop2.Font = shared.deffont or Enum.Font.Arial
						drop2.TextSize = 14
						drop2.ZIndex = 8
						drop2.BorderSizePixel = 0
						drop2.Name = listobj
	...
	GuiLibrary["CreateNotification"] = function(top, bottom, duration, customicon)
		...
		textlabel1.Font = shared.deffont or Enum.Font.Arial
		...
		textlabel2.Font = shared.deffont or Enum.Font.Arial
		...
		task.spawn(function()
			pcall(function()
				bettertween2(frame, UDim2.new(1, -(size - 4), 1, -(150 + 80 * offset)), Enum.EasingDirection.In, Enum.EasingStyle.Quint, 0.25, true)
				task.wait(0.25)
				frame2:TweenSize(UDim2.new(0, 0, 0, 2), Enum.EasingDirection.In, Enum.EasingStyle.Linear, duration, true)
				task.wait(duration)
				bettertween2(frame, UDim2.new(1, 0, 1, frame.Position.Y.Offset), Enum.EasingDirection.In, Enum.EasingStyle.Quint, 0.25, true)
				task.wait(0.25)
				frame:Remove()
			end)
		end)
